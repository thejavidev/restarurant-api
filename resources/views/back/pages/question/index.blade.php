        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <div class="global_buttons">
                    <a href="{{ route('question.create') }}" class="btn login_btn btn-focus ">Add</a>
                </div>
                ...
                <table class="table table-vcenter table-mobile-md card-table bg px-4 py-4">
                    ...
                    @foreach($question as $question)
                        <tr>
                            ...
                            <td class="text-center">{{ $question->q_text1_az }}</td>

                            <td>
                                <div class="btn-list align-items-center justify-content-center">
                                    <a href="{{ route('question.edit',$question->id) }}" class="btn btn-blue"><i class="fa fa-pen"></i></a>
