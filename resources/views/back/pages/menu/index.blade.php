        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <div class="global_buttons">
                    <a href="{{ route('menu.create') }}" class="btn login_btn btn-focus ">Add</a>
                </div>
                ...
                <table class="table table-vcenter table-mobile-md card-table bg px-4 py-4">
                    ...
                    @foreach($menu as $menu)
                        <tr>
                            <td class="text-center"><img src="{{ asset('files/menu/'.$menu->src) }}" style="width: 100px" alt=""></td>
                            <td class="text-center">{{ $menu->menu_title_az }}</td>

                            <td>
                                <div class="btn-list align-items-center justify-content-center">
                                    <a href="{{ route('menu.edit',$menu->id) }}" class="btn btn-blue"><i class="fa fa-pen"></i></a>
