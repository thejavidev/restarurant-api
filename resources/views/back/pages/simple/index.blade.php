        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <div class="global_buttons">
                    <a href="{{ route('simple.create') }}" class="btn login_btn btn-focus ">Add</a>
                </div>
                ...
                <table class="table table-vcenter table-mobile-md card-table bg px-4 py-4">
                    ...
                    @foreach($simple as $simple)
                        <tr>
                            <td class="text-center"><img src="{{ asset('files/simple/'.$simple->src) }}" style="width: 60px" alt=""></td>
                            <td class="text-center">{{ $simple->text_1_az }}</td>

                            <td>
                                    <div class="btn-list align-items-center justify-content-center">
                                    <a href="{{ route('simple.edit',$simple->id) }}" class="btn btn-blue"><i class="fa fa-pen"></i></a>
                                    <form action="{{ route('simple.destroy',$simple->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
