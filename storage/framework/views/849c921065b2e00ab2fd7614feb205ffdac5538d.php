    ...
    <div class="page">
        ...
        <div class="content m-3">
            <div class="mb-3 col-md-10 offset-md-1">
                ...
                <form action="<?php echo e(route('question.store')); ?>" method="POST" enctype="multipart/form-data" class="mb-5">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAYTLAR\DESKTOP\coffee\resources\views/back/pages/question/create.blade.php ENDPATH**/ ?>