        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <div class="global_buttons">
                    <a href="<?php echo e(route('menu.create')); ?>" class="btn login_btn btn-focus ">Add</a>
                </div>
                ...
                <table class="table table-vcenter table-mobile-md card-table bg px-4 py-4">
                    ...
                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center"><img src="<?php echo e(asset('files/menu/'.$menu->src)); ?>" style="width: 100px" alt=""></td>
                            <td class="text-center"><?php echo e($menu->menu_title_az); ?></td>

                            <td>
                                <div class="btn-list align-items-center justify-content-center">
                                    <a href="<?php echo e(route('menu.edit',$menu->id)); ?>" class="btn btn-blue"><i class="fa fa-pen"></i></a>
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAYTLAR\PROJECTS\VOLTER BISHOP\COFFEE\_coffee\resources\views/back/pages/menu/index.blade.php ENDPATH**/ ?>