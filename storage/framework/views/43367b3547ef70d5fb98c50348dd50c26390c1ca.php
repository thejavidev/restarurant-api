        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <div class="global_buttons">
                    <a href="<?php echo e(route('question.create')); ?>" class="btn login_btn btn-focus ">Add</a>
                </div>
                ...
                <table class="table table-vcenter table-mobile-md card-table bg px-4 py-4">
                    ...
                    <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($question->q_text1_az); ?></td>

                            <td>
                                <div class="btn-list align-items-center justify-content-center">
                                    <a href="<?php echo e(route('question.edit',$question->id)); ?>" class="btn btn-blue"><i class="fa fa-pen"></i></a>
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u719039710/domains/cavidan.info/public_html/coffee/resources/views/back/pages/question/index.blade.php ENDPATH**/ ?>