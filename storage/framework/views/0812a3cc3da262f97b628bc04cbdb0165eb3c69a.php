    ...
    <div class="page">
        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <a href="<?php echo e(route('simple.create')); ?>" class="btn btn-primary w-100">Add</a>
                <table class="table table-vcenter table-mobile-md card-table">
                    ...
                    <?php $__currentLoopData = $simple; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $simple): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><img src="<?php echo e(asset('files/simple/'.$simple->src)); ?>" style="width: 100px" alt=""></td>
                            <td><?php echo e($simple->title_az); ?></td>

                            <td>
                                <div class="btn-list flex-nowrap">
                                    <a href="<?php echo e(route('simple.edit',$simple->id)); ?>" class="btn btn-primary"><i class="fa fa-pen"></i></a>
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAYTLAR\DESKTOP\coffee\resources\views/back/pages/simple/index.blade.php ENDPATH**/ ?>