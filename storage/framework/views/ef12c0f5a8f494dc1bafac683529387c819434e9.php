    ...
    <div class="page">
        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <a href="<?php echo e(route('question.create')); ?>" class="btn btn-primary w-100">Add</a>
                <table class="table table-vcenter table-mobile-md card-table">
                    ...
                    <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($question->q_text1_az); ?></td>

                            <td>
                                <div class="btn-list flex-nowrap">
                                    <a href="<?php echo e(route('question.edit',$question->id)); ?>" class="btn btn-primary"><i class="fa fa-pen"></i></a>
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAYTLAR\DESKTOP\coffee\resources\views/back/pages/question/index.blade.php ENDPATH**/ ?>