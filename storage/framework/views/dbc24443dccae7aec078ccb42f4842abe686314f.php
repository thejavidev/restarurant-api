        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2">
                <div class="global_buttons">
                    <a href="<?php echo e(route('services.create')); ?>" class="btn login_btn btn-focus ">Add</a>
                </div>
                ...
                <table class="table table-vcenter table-mobile-md card-table bg px-4 py-4">
                    ...
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($service->name_az); ?></td>

                            <td>
                                <div class="btn-list align-items-center justify-content-center">
                                    <a href="<?php echo e(route('services.edit',$service->id)); ?>" class="btn btn-blue"><i class="fa fa-pen"></i></a>
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAYTLAR\PROJECTS\VOLTER BISHOP\COFFEE\_coffee\resources\views/back/pages/services/index.blade.php ENDPATH**/ ?>