        ...
        <div class="content m-3">
            <div class="mb-3 col-md-10 offset-md-1">
                <div class="d-flex justify-content-center align-items-center mb-4">
                    <a href="<?php echo e(route('question.index')); ?>" class="btn login_btn btn_blue btn-margin btn-focus ">All</a>
                </div>

                <form action="<?php echo e(route('question.update',$question->id)); ?>" method="POST" enctype="multipart/form-data" class="mb-5 bg px-4">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u719039710/domains/cavidan.info/public_html/coffee/resources/views/back/pages/question/edit.blade.php ENDPATH**/ ?>