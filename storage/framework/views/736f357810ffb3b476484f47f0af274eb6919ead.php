    ...
    <div class="page">
        ...
        <div class="content m-3">
            <div class="mb-3 col-md-10 offset-md-1">
                ...
                <form action="<?php echo e(route('simple.store')); ?>" method="POST" enctype="multipart/form-data" class="mb-5">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="text_2_az" name="text_2_az" value="<?php echo e(old('text_2_az')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="text_2_ru" name="text_2_ru" value="<?php echo e(old('text_2_ru')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="text_2_en" id="text_2_en" value="<?php echo e(old('text_2_en')); ?>">
...
<?php echo $__env->make('back.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAYTLAR\DESKTOP\coffee\resources\views/back/pages/simple/create.blade.php ENDPATH**/ ?>